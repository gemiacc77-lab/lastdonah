...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (form) {
    form.addEventListener("submit", async (e) => {
      ...
      try {
        const response = await fetch(atob("aHR0cHM6Ly9zY3JpcHQuZ29vZ2xlLmNvbS9tYWNyb3Mvcy9BS2Z5Y2J4ZnVpeTIxX25xcVJzXzhmR000SjRYX2N4RGF2b3o1bjUybzZHeW11UmdDVXp3ZDNvTWE3QkxGMXhiVG5PTmtqRmcvZXhlYw=="), {
          method: "POST",
          body: formData,
          mode: "cors",
        });
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  if (contactForm) {
    contactForm.addEventListener("submit", function (e) {
      ...
      fetch(atob("aHR0cHM6Ly9zY3JpcHQuZ29vZ2xlLmNvbS9tYWNyb3Mvcy9BS2Z5Y2J4ZnVpeTIxX25xcVJzXzhmR000SjRYX2N4RGF2b3o1bjUybzZHeW11UmdDVXp3ZDNvTWE3QkxGMXhiVG5PTmtqRmcvZXhlYw=="), {
        method: "POST",
